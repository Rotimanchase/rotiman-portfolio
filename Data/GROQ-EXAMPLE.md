...
Click on the "Vision" tab (eye icon)
Paste any query below and click "Run Query" (or Ctrl/Cmd + Enter)
...
Optimize image queries with image URL builder:
...
Use projections to get only what you need:
