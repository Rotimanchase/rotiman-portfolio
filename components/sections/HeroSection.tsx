...
import { BackgroundRippleEffect } from "@root/components/ui/background-ripple-effect"; // Import the component
import { urlFor } from "@root/sanity/lib/image";
import { sanityFetch } from "@root/sanity/lib/live";
        ...
        <div className="@container">
          <div className="grid grid-cols-1 @3xl:grid-cols-2 gap-8 @lg:gap-12 items-center">
            ...
            <div className="@container/hero space-y-4 @md/hero:space-y-6">
              <h1 className="text-4xl @md/hero:text-3xl @lg/hero:text-6xl font-bold tracking-tight">
                {profile.firstName}{" "}
