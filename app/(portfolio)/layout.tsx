...
import { SanityLive } from "@root/sanity/lib/live";
import "../globals.css";
import { draftMode } from "next/headers";
import Script from "next/script";
import { VisualEditing } from "next-sanity/visual-editing";
import { AppSidebar } from "@root/components/app-sidebar";
import { DisableDraftMode } from "@root/components/DisableDraftMode";
import SidebarToggle from "@root/components/SidebarToggle";
import { ThemeProvider } from "@root/components/ThemeProvider";
import { ModeToggle } from "@root/components/ui/DarkModeToggle";
import { FloatingDock } from "@root/components/ui/FloatingDock";
...
export const metadata: Metadata = {
  title: "Rotiman Portfolio",
  description: "Rotiman's personal portfolio website.",
};
